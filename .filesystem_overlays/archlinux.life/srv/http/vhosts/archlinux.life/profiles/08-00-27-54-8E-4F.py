...
with archinstall.Filesystem(os_drive, archinstall.GPT) as fs:
	...
	with archinstall.Installer(os_drive.partition[1], boot_partition=os_drive.partition[0], hostname='archmirror') as installation:
		...
		if installation.minimal_installation():
			...
			archinstall.storage['archmirror-packages'] = 'base base-devel linux linux-firmware efibootmgr nano btrfs-progs'
